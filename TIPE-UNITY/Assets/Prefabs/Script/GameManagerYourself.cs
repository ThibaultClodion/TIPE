...
//This is the GameManager for control the human YOURSELF ## You have to change the name of this file to GameManager to launch the simulation with it ##
public class GameManagerYourself : MonoBehaviour
{
